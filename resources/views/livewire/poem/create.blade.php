<div class="w-fill block" x-data="{ titleFocused: @entangle('titleFocused')}">
    <form wire:submit.prevent="savePoem">
        ...
        <div class="flex flex-row flex-wrap -mx-4 items-stretch">
            ...
            <div class="w-full px-4 py-2">
                <div class="flex flex-row justify-between items-center w-full pt-2">
                    <div>
                        <button type="submit" class="inline-block text-center border border-admin-main rounded-md min-h-[42px] h-auto py-2.5 p-5 text-white bg-admin-main text-base font-medium leading-tight hover:bg-admin-hover hover:border-admin-hover transition ease-in-out duration-200">Save Poem</button>
                    </div>

                    <div>
                        <a href="{{ route('poem.adminIndex') }}" class="inline-block text-center border border-admin-main rounded-md min-h-[42px] h-auto py-2.5 p-5 text-admin-main bg-white text-base font-medium leading-tight hover:bg-admin-hover hover:border-admin-hover hover:text-white transition ease-in-out duration-200">Cancel</a>
                    </div>
                </div>
            </div>
        </div>
