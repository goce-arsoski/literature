    ...
    <div class="flex flex-row flex-wrap h-full w-full justify-between items-center pl-3 sm:pl-4 lg:pl-5 pr-4 lg:pr-6 bg-white">
        ...
        <div class="flex flex-row h-full flex-wrap items-center" x-data="{open:false, active:false}">
            {{-- <div class="h-full block lg:hidden">
                <a href="#" class="tooltip-header group mr-0 sm:mr-2 md:mr-4 flex h-full p-2 sm:p-3 border-solid border-[3px] border-transparent hover:border-b-admin-main transition-all leading-none [&.active]:border-b-admin-main relative" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Invite Candidate">
                    <span class="h-full">
                        <span class="flex h-full content-center items-center">
                            <svg  class="fill-[#6B7280] group-hover:fill-admin-main group-[&.active]:fill-admin-main  transition-all w-4 sm:w-5 h-auto"  width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="h-full">
                <a href="#" data-bs-toggle="modal" data-bs-target="#reviews-modal" class="tooltip-header group mr-0 sm:mr-2 md:mr-4 flex h-full p-2 sm:p-3 border-solid border-[3px] border-transparent hover:border-b-admin-main transition-all leading-none [&.active]:border-b-admin-main relative" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Review">
                    <span class=" min-w-[14px] md:min-w-[18px] h-[14px] md:h-[18px] text-center leading-[14px] md:leading-[18px] text-[10px] md:text-xs px-1 md:px-1.5 text-white font-bold inline-block rounded-full bg-admin-main absolute left-[60%] top-2.5 z-10">1</span>
                    <span class="h-full">
                        <span class="flex h-full content-center items-center">
                            <svg  class="fill-[#6B7280] group-hover:fill-admin-main group-[&.active]:fill-admin-main  transition-all w-4 sm:w-5 h-auto" width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="h-full" @mouseover="notificationtoggle = false, open = false, active = false">
                <a href="#" class="@if(Route::is('chat')) active @endif tooltip-header group mr-0 sm:mr-2 md:mr-4 flex h-full p-2 sm:p-3 border-solid border-[3px] border-transparent hover:border-b-admin-main transition-all leading-none [&.active]:border-b-admin-main relative" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Chats">
                <span class=" min-w-[14px] md:min-w-[18px] h-[14px] md:h-[18px] text-center leading-[14px] md:leading-[18px] text-[10px] md:text-xs px-1 md:px-1.5 text-white font-bold inline-block rounded-full bg-admin-main absolute left-[60%] top-2.5 z-10">1</span>
                    <span class="h-full">
                        <span class="flex h-full content-center items-center">
                            <svg class="fill-[#6B7280] group-hover:fill-admin-main group-[&.active]:fill-admin-main  transition-all w-4 sm:w-5 h-auto" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="h-full relative z-10"   x-bind:class="{'z-[60]' : active}"  @click.away="active = false, notificationtoggle = false"   >
                <a href="#" class="tooltip-header group mr-2 md:mr-4 flex h-full p-2 sm:p-3 border-solid border-[3px] border-transparent hover:border-b-admin-main [&.active]:border-b-admin-main transition-all leading-none relative" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Notifications"  x-on:click="open = !open, active = !active, notificationtoggle= !notificationtoggle" x-bind:class="{'active' : active}" >
                    <span class=" min-w-[14px] md:min-w-[18px] h-[14px] md:h-[18px] text-center leading-[14px] md:leading-[18px] text-[10px] md:text-xs px-1 md:px-1.5 text-white font-bold inline-block rounded-full bg-admin-main absolute left-[60%] top-2.5 z-10">1</span>
                    <span class="h-full">
                        <span class="flex h-full content-center items-center">
                            <svg class="fill-[#6B7280] group-hover:fill-admin-main group-[&.active]:fill-admin-main transition-all w-3.5 sm:w-4"  width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div 
                        ...
                        <div class="flex flex-row flex-wrap justify-between items-center">
                            <div>
                                <div class="flex flex-row align-middle -mx-2">
                                    <div class="text-base md:text-lg leading-1 font-bold px-2">Notifications</div>
                                    <div class="text-lg font-bold px-2">
                                        <div class="min-w-[18px] h-[18px] text-center leading-[18px] text-xs px-1.5 align-middle -mt-1 text-white font-bold inline-block rounded-full bg-admin-main z-10">1</div>
                                    </div>
                                </div>
                            </div>
                            <div>
                                <a href="#" class="underline text-xs md:text-sm text-neutral-800">Mark all as read</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class=" overflow-y-auto max-h-[250px] overflow-x-hidden">
                        <p class="text-base md:text-lg pt-2 font-bold mb-1 px-4">Today</p>
                        <div class="flex items-center px-5 py-2 w-full hover:bg-gray-200 hover:cursor-pointer transition-all relative pr-6">
                            ...
                            <span class="absolute top-1/2 -translate-y-1/2 right-3 w-2 h-2 rounded-full bg-admin-main"></span>
                        </div>
            ...
            <div class="relative z-10" x-data={openn:false}  x-bind:class="{'z-[60]' : active}"  @click.away="active = false"   >
                ...
                <div 
                    ...
                    <ul class="m-0">
                        <li class="pb-2.5">
                            <a href="{{ route('profile.show') }}" class="@if(Route::is('profile.show')) active @endif block group py-2 pr-2 pl-10 sm:pl-12 text-base md:text-lg relative text-gray-500 leading-tight rounded-lg bg-transparent font-normal transition-all duration-300  hover:bg-blue-50 hover:text-admin-main  focus:bg-blue-50 focus:text-admin-main hover:font-bold [&.active]:text-admin-main [&.active]:font-bold [&.active]:bg-blue-50">
                                <svg width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" class="fill-[#6B7280] group-hover:fill-admin-main transition-all duration-300 absolute left-3 top-1/2 -translate-y-1/2 z-10 inline-block group-[&.active]:fill-admin-main w-4 sm:w-5">
                        ...
                        <li class="pb-0">
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                @csrf
                                <a href="{{ route('logout') }}" @click.prevent="$root.submit();" class="block group py-2 pr-2 pl-10 sm:pl-12 text-base md:text-lg relative text-gray-500 leading-tight rounded-lg bg-transparent font-normal transition-all duration-300  hover:bg-blue-50 hover:text-admin-main  focus:bg-blue-50 focus:text-admin-main hover:font-bold">
                                    <svg width="16" height="20" viewBox="0 0 16 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="fill-[#6B7280] group-hover:fill-admin-main transition-all duration-300 absolute left-3.5 top-1/2 -translate-y-1/2 z-10 inline-block w-3.5 sm:w-4">
