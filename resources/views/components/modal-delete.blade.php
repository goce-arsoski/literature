...
<section  class="fixed left-0 top-0 z-[1055] h-full w-full overflow-y-auto overflow-x-hidden outline-none hidden">
    <div class="pointer-events-none relative flex min-h-[calc(100%_-_40px)] w-auto items-center transition-all duration-300 ease-in-out mx-auto my-[20px] sm:my-[50px] sm:min-h-[calc(100%_-_100px)] max-w-[92vw] md:max-w-[550px]">
        <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none">
            <div class="flex flex-shrink-0 items-center justify-between rounded-t-md   !pb-0 p-4 md:p-5">
                <h5 class="text-xl font-medium mb-0 leading-normal text-neutral-800" id="exampleModalScrollableLabel">Delete photo</h5>
                <a href="#" class="w-9 h-9 md:w-11 md:h-11 rounded-lg bg-transparent transition-all hover:bg-gray-100 relative">
            ...
            <div class="relative p-4 md:p-5">
                <p>This photo will be permanently deleted.<br>This <strong>cannot</strong> be undone.</p>
            ...
            <div class="relative px-4 md:px-5 py-1  border-t border-t-solid border-t-gray-100">
                <div class="flex flex-row flex-wrap items-center -mx-2">
                    <div class="px-2 py-2">
                        <a href="#" class="block text-center border border-red-400 rounded-md min-h-[46px] h-auto py-2 p-1.5 w-[125px] max-w-full text-white bg-red-400 text-base md:text-lg leading-tight hover:bg-red-600 hover:border-red-600 transition ease-in-out duration-200 font-bold">Delete</a>
                    </div>
                    <div class="px-2 py-2">
                        <a href="#" class="block text-center border border-gray-200 rounded-md min-h-[46px] h-auto py-2 p-1.5 w-[125px] max-w-full border-solid  text-base md:text-lg  text-neutral-800 bg-transparent  hover:bg-gray-100 transition ease-in-out duration-200 font-bold">Cancel</a>
                    </div>
                </div>
